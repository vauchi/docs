...
For detailed instructions, see the [Exchange Contacts](guides/exchange.md) guide.
...
- **[Control what people see](guides/visibility.md)** — Hide your home address from work contacts
- **[Set up multi-device](guides/multi-device.md)** — Use Vauchi on your phone and tablet
- **[Create a backup](features/backup-recovery.md)** — Protect your identity in case you lose your device
...
- See [features](features/index.md) for detailed explanations
- Read the [how-to guides](guides/index.md) for step-by-step instructions
