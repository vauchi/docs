...
flowchart TB
    ...
    Proxy["SELF-HOSTED REVERSE PROXY (nginx/caddy)<br/>• Strips all client-identifying headers<br/>• Relay never sees client IP addresses in steady state<br/>(see §Bootstrap Exceptions)"]
