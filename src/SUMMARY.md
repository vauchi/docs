...
- [End-to-End Encryption](./users/features/encryption.md)
- [Backup & Recovery](./users/features/backup-recovery.md)
- [Multi-Device Support](./users/features/multi-device.md)
...
- [Multi-Device Setup](./users/guides/multi-device.md)
...
- [Device Linking](./developers/diagrams/device-linking.md)
- [Contact Recovery](./developers/diagrams/contact-recovery.md)
- [Crypto Hierarchy](./developers/diagrams/crypto-hierarchy.md)